    ...
    return (
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          } rounded-lg text-[color:var(--color-admin-text-primary)] text-sm transition-all duration-300 focus:outline-none focus:border-[color:var(--color-admin-border-focus)] focus:shadow-[0_0_0_3px_rgba(74,158,255,0.1)] placeholder:text-[color:var(--color-admin-text-muted)] disabled:opacity-50 ${className}`}
          {...props}
        />
        {error && (
